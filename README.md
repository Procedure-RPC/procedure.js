...
[![npm test](https://img.shields.io/github/actions/workflow/status/procedure-rpc/procedure.js/npm-test.yml?logo=github&logoColor=aaa&label=npm%20test&labelColor=222&style=flat-square)](https://github.com/Procedure-RPC/procedure.js/actions/workflows/npm-test.yml "View npm test on GitHub Actions") [![publish code coverage](https://img.shields.io/github/actions/workflow/status/procedure-rpc/procedure.js/publish-code-coverage.yml?logo=github&logoColor=aaa&label=publish%20code%20coverage&labelColor=222&style=flat-square)](https://github.com/Procedure-RPC/procedure.js/actions/workflows/publish-code-coverage.yml "View publish code coverage on GitHub Actions") [![publish package](https://img.shields.io/github/actions/workflow/status/procedure-rpc/procedure.js/publish-package.yml?logo=github&logoColor=aaa&label=publish%20package&labelColor=222&style=flat-square)](https://github.com/Procedure-RPC/procedure.js/actions/workflows/publish-package.yml "View publish package on GitHub Actions") [![publish docs](https://img.shields.io/github/actions/workflow/status/procedure-rpc/procedure.js/publish-docs.yml?logo=github&logoColor=aaa&label=publish%20docs&labelColor=222&style=flat-square)](https://github.com/Procedure-RPC/procedure.js/actions/workflows/publish-docs.yml "View publish docs on GitHub Actions")
